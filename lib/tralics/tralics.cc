...
const char* tralics_rcsid=
  "$Id: tralics.C,v 2.193 2011/06/01 14:54:42 grimm Exp $";
...
int main_function (int argc, const char* argv[], MainCallback callback)
{
  MainClass M;
  the_main = &M;
...
void set_everyjob(String s) {everyjob_string = s;}
