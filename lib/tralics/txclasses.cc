...
const char* txclasses_rcsid =
  "$Id: txclasses.C,v 2.36 2011/06/28 08:15:25 grimm Exp $";
...
void Parser::resetClass()
{
    the_class_data.packages.clear();
    the_class_data.seen_document_class = false;
    the_class_data.using_default_class = false;
    the_class_data.packages.push_back(new LatexPackage("Fdummy file"));
    the_class_data.unused_options.clear();
    the_class_data.global_options.clear();
    the_class_data.documentclass_hook.clear();
}
