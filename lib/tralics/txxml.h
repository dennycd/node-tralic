...
class Xml
{
 ...
 public:
  ...
  const vector<Xmlp>& get_tree() const { return tree; } //expose the xml tree
  void convert_to_string_safe(string&) const; //safe version of convert to xml string without depending on opened disk file handler 
